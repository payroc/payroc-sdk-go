...
func (r *RawClient) Create(
...
) (*core.Response[*payroc.ApplePayResponseSession], error) {
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/processing-terminals/%v/apple-pay-sessions",
	...
	var response *payroc.ApplePayResponseSession
	...
	return &core.Response[*payroc.ApplePayResponseSession]{
