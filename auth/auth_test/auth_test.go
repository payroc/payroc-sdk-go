...
func TestAuthRetrieveTokenWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Auth.RetrieveToken(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestAuthRetrieveTokenWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestAuthRetrieveTokenWithWireMock", "POST", "/authorize", nil, 1)
}
