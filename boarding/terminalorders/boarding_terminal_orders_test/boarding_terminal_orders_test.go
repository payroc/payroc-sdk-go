...
package boarding_terminal_orders_test
...
func TestBoardingTerminalOrdersRetrieveWithWireMock(
	t *testing.T,
) {
	wiremockPort := os.Getenv("WIREMOCK_PORT")
	if wiremockPort == "" {
	...
	_, invocationErr := client.Boarding.TerminalOrders.Retrieve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestBoardingTerminalOrdersRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestBoardingTerminalOrdersRetrieveWithWireMock", "GET", "/terminal-orders/12345", nil, 1)
}
