...
func (r *RawClient) Submit(
...
) (*core.Response[*payroc.RefundInstruction], error) {
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/devices/%v/refund-instructions",
	...
	var response *payroc.RefundInstruction
	...
	return &core.Response[*payroc.RefundInstruction]{
...
func (r *RawClient) Retrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/refund-instructions/%v",
		request.RefundInstructionId,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
