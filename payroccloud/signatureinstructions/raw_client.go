...
func (r *RawClient) Submit(
...
) (*core.Response[*payroc.SignatureInstruction], error) {
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/devices/%v/signature-instructions",
	...
	var response *payroc.SignatureInstruction
	...
	return &core.Response[*payroc.SignatureInstruction]{
...
func (r *RawClient) Retrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/signature-instructions/%v",
		request.SignatureInstructionId,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
