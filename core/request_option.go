...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/payroc/payroc-sdk-go")
	headers.Set("X-Fern-SDK-Version", "v0.0.3394")
	return headers
}
...
func (c *ApiKeyOption) applyRequestOptions(opts *RequestOptions) {
...
// TokenGetterOption implements the RequestOption interface.
type TokenGetterOption struct {
	TokenGetter TokenGetter
}

func (t *TokenGetterOption) applyRequestOptions(opts *RequestOptions) {
	opts.tokenGetter = t.TokenGetter
}

// WithTokenGetter returns a RequestOption that sets the token getter function.
func WithTokenGetter(getter TokenGetter) *TokenGetterOption {
	return &TokenGetterOption{
		TokenGetter: getter,
	}
}
