...
func (r *RawClient) List(
...
) (*core.Response[*payroc.PaginatedFundRecipients], error) {
	...
	var response *payroc.PaginatedFundRecipients
	...
	return &core.Response[*payroc.PaginatedFundRecipients]{
...
func (r *RawClient) Create(
	...
	opts ...option.RequestOption,
) (*core.Response[*payroc.FundingRecipient], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		internal.ResolveEnvironmentBaseURL(
	...
	var response *payroc.FundingRecipient
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*payroc.FundingRecipient]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) ListAccounts(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/funding-recipients/%v/funding-accounts",
		request.RecipientId,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
...
func (r *RawClient) CreateAccount(
	ctx context.Context,
...
func (r *RawClient) ListOwners(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/funding-recipients/%v/owners",
		request.RecipientId,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
